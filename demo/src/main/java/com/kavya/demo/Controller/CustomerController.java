...
public class CustomerController {
    ...
    public String login(@RequestParam String username, @RequestParam String password, HttpSession session, Model model) {
        ...
        //use requestbody as the input  insead of requestparam because if you guys are using the requestparam then you have to pass the data in the url and it is not secure
